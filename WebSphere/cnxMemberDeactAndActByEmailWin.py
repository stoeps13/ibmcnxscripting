...
ibmcnxscript.importJar('C:/IBM/JDBC_/db2java.zip')
...
# conn = DriverManager.getConnection( 'jdbc:db2://192.168.110.100:50000/PEOPLEDB', 'lcuser', 'password' ) 
# Class.forName('COM.ibm.db2.jdbc.app.DB2Driver').newInstance()
Class.forName("COM.ibm.db2.jdbc.app.DB2Driver").newInstance()
conn = DriverManager.getConnection( 'jdbc:db2:peopleDB','lcuser','password')
